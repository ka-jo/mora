 ...
 */
export function Ref<T>(value: T, options?: RefOptions): Ref<T>; // callable constructor
...
export namespace Ref {
	 ...
	 */
	function deref<T>(maybeRef: T | Ref<T>): T;
	/**
	 ...
	 */
	function isAborted(ref: Ref<unknown>): boolean;
	/**
 ...
 */
export function Store<T extends object>(value: T, options?: StoreOptions): StoreInstance<T>; // callable constructor
...
export namespace Store {
	 ...
	 */
	function readonly<T extends object>(store: StoreInstance<T>): StoreInstance<T>;
	/**
	 ...
	 */
	function getRef<T>(access: T): Ref<T>;
}
